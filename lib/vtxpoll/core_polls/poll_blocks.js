...
exports.poll_blocks = function (state, emit) { return __awaiter(_this, void 0, void 0, function () {
    var current_height, e_3, block_nums;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(ready_1.ready(state) && !polling)) return [3 /*break*/, 6];
                polling = true;
                current_height = void 0;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
exports.poll_blocks_interval = 5;

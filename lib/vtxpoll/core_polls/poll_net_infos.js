...
var polling = false;
exports.poll_net_infos = function (state, emit) { return __awaiter(_this, void 0, void 0, function () {
    var web3, current_coinbase, _a, current_net;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(ready_1.ready(state) && !polling)) return [3 /*break*/, 3];
                polling = true;
...
exports.poll_net_infos_interval = 5;

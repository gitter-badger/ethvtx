...
var polling = false;
exports.poll_events = function (state, emit) { return __awaiter(_this, void 0, void 0, function () {
    var e_1, _a, e_2, _b, events, _c, _d, event_sig, from, to, contract, caught_events, caught_events_1, caught_events_1_1, caught_event, e_1_1;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                if (!(ready_1.ready(state) && !polling && state.blocks.initial_height !== null && state.blocks.current_height !== null)) return [3 /*break*/, 9];
                polling = true;
                events = state.events.followed;
                _e.label = 1;
            case 1:
                _e.trys.push([1, 6, 7, 8]);
                _c = __values(Object.keys(events)), _d = _c.next();
                _e.label = 2;
            case 2:
            ...
            case 3:
                ...
                try {
                    for (caught_events_1 = __values(caught_events), caught_events_1_1 = caught_events_1.next(); !caught_events_1_1.done; caught_events_1_1 = caught_events_1.next()) {
                    ...
                    try {
                        if (caught_events_1_1 && !caught_events_1_1.done && (_b = caught_events_1.return)) _b.call(caught_events_1);
                    }
...
exports.poll_events_interval = 5;

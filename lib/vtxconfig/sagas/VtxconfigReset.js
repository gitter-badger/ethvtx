...
function VtxconfigResetSaga(action) {
    var e_1, state, web3, coinbase, _a, net, genesis_hash;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!action.enable) return [3 /*break*/, 6];
            ...
            case 5:
                _b.sent();
                return [2 /*return*/];
            case 6: return [4 /*yield*/, effects_1.select()];
            case 7:
                state = (_b.sent());
            ...
            case 15:
                _b.sent();
                return [4 /*yield*/, effects_1.put(actions_1.VtxconfigResetSectionComplete('vtxconfig'))];
            case 16:
                _b.sent();
                return [2 /*return*/];
        }

...
const contractVarForceRefreshReducer = (state, action) => {
    return Object.assign({}, state, { [action.contractName]: Object.assign({}, state[action.contractName], { [action.contractAddress.toLowerCase()]: Object.assign({}, state[action.contractName][action.contractAddress.toLowerCase()], { instance: Object.assign({}, state[action.contractName][action.contractAddress.toLowerCase()].instance, { vortexMethods: Object.assign({}, state[action.contractName][action.contractAddress.toLowerCase()].instance.vortexMethods, { [action.methodName]: Object.assign({}, state[action.contractName][action.contractAddress.toLowerCase()].instance.vortexMethods[action.methodName], { cache: Object.assign({}, state[action.contractName][action.contractAddress.toLowerCase()].instance.vortexMethods[action.methodName].cache, { [action.methodHash]: Object.assign({}, state[action.contractName][action.contractAddress.toLowerCase()].instance.vortexMethods[action.methodName].cache[action.methodHash], { synced: false }) }) }) }) }) }) }) });
};
